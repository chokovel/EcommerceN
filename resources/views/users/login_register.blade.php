...
<div class="page-large-title">
		<div class="container">
			...
			<nav class="woocommerce-breadcrumb">
				<a class="home" href="{{ url('/')}}">Home</a> / <a href="{{ url('viewcart')}}">Cart</a> / <span>Login/Register</span>
			</nav>
		</div><!-- .container -->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-1 ">
                <div class="login-form  cart_info"><!--login form-->
            ...
            <div class="col-sm-4">
                <div class="signup-form  cart_info"><!--sign up form-->
