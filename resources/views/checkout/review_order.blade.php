...
<div class="page-large-title">
		<div class="container">
			...
			<nav class="woocommerce-breadcrumb">
				<a class="home" href="{{ url('/')}}">Home</a> / <a href="{{ url('check-out')}}">Checkout</a> / <span>Order Review</span>
			</nav>
		</div><!-- .container -->
                ...
                <div class="col-sm-12">
                    ...
                    <section id="cart_items">
                        ...
                        <div class="table-responsive cart_info">
                            <table class="table table-condensed bg-green">
                                <thead>
                                <tr class="cart_menu">
                        ...
                        <span>
                            ...
                            <button type="submit" class="button-green button-normal" style="float: right;">Order Now</button>
                        </div>
                    </section>
