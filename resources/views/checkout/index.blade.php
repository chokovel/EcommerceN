...
<div class="page-large-title">
		<div class="container">
			...
			<nav class="woocommerce-breadcrumb">
				<a class="home" href="{{ url('/')}}">Home</a> / <a href="{{ url('viewcart')}}">Cart</a> / <span>Checkout</span>
			</nav>
		</div><!-- .container -->
            ...
            <form action="{{url('/submit-checkout')}}" method="post" class="form-horizontal">
                ...
                <div class="col-sm-4">
                    <div class="signup-form"><!--sign up form-->
                        ...
                        <button type="submit" class="button-green button-normal" style="float: right;">CheckOut</button>
                    </div><!--/sign up form-->
                </div>
            </form>
        </div>
