...
<div id="sidebar"><a href="{{url('/admin')}}" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
    <ul>
        ...
        <li class="submenu {{$menu_active==5? ' active':''}}"> <a href="#"><i class="icon icon-th-list"></i> <span>Frontend CMS</span></a>
            <ul>
                <li><a href="{{ route('newsletter.index') }}">List Subscribers</a></li>
                <li><a href="{{ route('blogs.index')}}">Blog List</a></li>
                <li><a href="{{ route('carousels.index') }}">Main Page Image</a></li>
                <li><a href="{{ route('testimonies.index')}}">List Testimonials</a></li>
            </ul>
        </li>
    </ul>
</div>
